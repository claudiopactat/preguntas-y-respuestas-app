...
export const Result = ({ score, questionsFiltered, onReset }) => {
  return (
    <div className="flex flex-col items-center">
      <div className="flex flex-col justify-evenly items-center w-[600px] h-[600px] shadow-xl rounded-lg gap-5">
    ...
    text-transparent text-6xl animate-pulse"
        ...
        <button
          className="border px-5 py-2 rounded-lg transition-all font-bold hover:bg-yellow-500
    hover:text-gray-900"
          onClick={onReset}
        >
          Vamos de nuevo
