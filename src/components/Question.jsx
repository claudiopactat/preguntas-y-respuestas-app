    ...
    <>
      {activeResults ? (
        ...
        <div className="flex flex-col justify-center items-center">
          <div
            className="flex flex-col justify-between shadow-md shadow-slate-400 w-[600px] h-[600px] p-10 
      rounded-lg"
          >
            <div className="flex justify-between">
              <span className="text-xl font-bold">
                {/* Numero de pregnta actual y numero de preguntas totales */}
        ...
        hover:text-gray-900"
            ...
            <div className="grid grid-col-4 gap-5">
              {/* Mapeamos un arreglo de respuesta correctas y respuestas incorrectas */}
            ...
            {indexQuestion + 1 === questionsFiltered.length ? (
              <button
                className="border p-2 border-yellow-600 text-yellow-600 rounded-md px-5 py-2
